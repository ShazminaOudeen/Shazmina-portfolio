...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative py-20 md:py-28 px-4 md:px-8 bg-washi dark:bg-ink transition-colors scroll-mt-20 md:scroll-mt-24"
    >
      <div className="max-w-3xl mx-auto">
        ...
        {/* Form - bordered card container, matches the rest of the site's
            language instead of floating inputs */}
        <motion.form
